...
完整指标见 [logs/train_metrics.csv](../logs/train_metrics.csv)，训练摘要见 [logs/train_log_summary.md](../logs/train_log_summary.md)。推理结果见 [results/inference_report.md](../results/inference_report.md)。
