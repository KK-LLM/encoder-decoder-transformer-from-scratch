...
从零手写 Transformer 模型结构、训练闭环、推理闭环的实验仓库。当前版本为 Encoder-Decoder v0_baseline，后续将逐步扩展优化版本和 Decoder-only 架构。
...
| 项目 | 版本 | 架构 | 状态 |
|------|------|------|------|
| Encoder-Decoder | [v0_baseline](./projects/encoder_decoder/v0_baseline/) | Post-LN Transformer | 训练进行中 |
| Encoder-Decoder | v1_improved | 待定 | 计划中 |
| Decoder-only | — | GPT-style | 计划中 |
...
2. **[v0_baseline README](./projects/encoder_decoder/v0_baseline/README.md)** — 当前版本的训练配置、数据说明、当前状态
3. **[train_encoder_decoder_opus.py](./projects/encoder_decoder/v0_baseline/src/train_encoder_decoder_opus.py)** — 手写模型源码 + 训练闭环
4. **[infer_encoder_decoder.py](./projects/encoder_decoder/v0_baseline/src/infer_encoder_decoder.py)** — 推理闭环
